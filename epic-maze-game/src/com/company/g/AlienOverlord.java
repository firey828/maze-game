...
public class AlienOverlord {
    ...
    public AlienOverlord() {
        ...
        _twinElementalDragon.option(new String[]{"ok boomer"},
                "" +
                        "Long ago, there were but four kinds of creatures in the world.\n" +
                        "The resourceful HUMAN.\n" +
                        "The cunning MINOTAUR.\n" +
                        "The staggering ZOMBIE.\n" +
                        "and the MOUSE.\n");
        _twinElementalDragon.option(new String[]{"ok boomer"},
                "" +
                        "In these ancient times, there was peace among each and every one\n" +
                        "of these races. But the ZOMBIES and MINOTAURS grew weary of the\n" +
                        "ever-growing threat that was HUMANITY, and, before the first era\n" +
                        "of the Earth had come to an end, they had vanished without a trace.\n");
        _twinElementalDragon.option(new String[]{"ok boomer"},
                "" +
                        "Not that you knew about any of that, of course.\n" +
                        "\n" +
                        "You only summoned these creatures because of a dare.\n" +
                        "\n" +
                        "Sucks to suck.");
        _twinElementalDragon.msg(new ImageIcon(getClass().getResource("helpControls.png")));
        _twinElementalDragon.msg(new ImageIcon(getClass().getResource("helpCreatures.png")));
        _twinElementalDragon.msg("changelog:\n" +
                ...
                "             - added music\n" +
                "/03/19/2020/ - added sans undertale\n" +
                "/03/23/2020/ - added helpful images");
        ...
        if (debugS.equalsIgnoreCase("NORMAL")) {
            ...
            while (counter < _levels.length) {
                ...
                if (new MessageCentral().answerIsValidPerQuestion(riddleThing, guess) && _f.getPlayer().hasKey()) {
                    ...
                    new MessengerFromAcrossTheAbyss().msg(new ImageIcon(getClass().getResource("deathSphinxVore.png")));
