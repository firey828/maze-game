...
public class Keyboard implements KeyListener {
    ...
    // yes, the keyboard class is responsible for updating the map, playing music, and picking up items
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (taur.getPosition().samePosAs(_f.getPlayer().getPosition())) {
            if (_f.getPlayer().hasSword()) {
                ...
                new MessengerFromAcrossTheAbyss().msg(new ImageIcon(getClass().getResource("deathMinotaur.png")));
                thing++;
                if (thing >= 3) {
                    new MessengerFromAcrossTheAbyss().msg(new ImageIcon(getClass().getResource("gameover.png")));
                    System.exit(0);
                } else {
                    _f.removePlayer();
        ...
        if (zombie.getPosition().samePosAs(_f.getPlayer().getPosition())) {
            if (_f.getPlayer().hasSword()) {
                ...
                new MessengerFromAcrossTheAbyss().msg(new ImageIcon(getClass().getResource("deathZombie.png")));
                thing++;
                if (thing >= 3) {
                    new MessengerFromAcrossTheAbyss().msg(new ImageIcon(getClass().getResource("gameover.png")));
                    System.exit(0);
        ...
        try {
            ...
            _audioStream.sTOPTHEMUSICBLEASE(true);
